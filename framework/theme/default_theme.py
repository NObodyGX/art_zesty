...
class DTheme(object):
    ...
    def __init__(self):
        ...
        self.widget.setv(f"background-color: {DTheme.g_bg_color}")
        self.widget.setv(f"color: {DTheme.g_color}")

        self.button = Gss("QPushButton")
        self.button.setv("border: none")
        self.button.setv("border-radius: none")
        self.button.setv(f"background-color: {DTheme.g_bg_color}")
        self.button.setv("padding: 0")
        self.button.setv(f"background-color: {DTheme.g_hover_bg_color}", k="hover")
        self.button.setv(f"background-color: {DTheme.g_hover_bg_color}", k="pressed")
        ...
        self.combox.setv(f"color: {DTheme.g_color}")
        ...
        self.combox.setv(f"background: {DTheme.g_bg_color}", k="focus")
        # combox 点击样式
        ...
        self.combox_ab_item.setv(f"color: {DTheme.g_color}")
        self.combox_ab_item.setv(f"background: {DTheme.g_bg_color}")
        self.combox_ab_item.setv("padding-left: 4px")
        self.combox_ab_item.setv("padding-right: 0px")
        self.combox_ab_item.setv(
            f"background: {DTheme.g_bg_color}", k="hover:!selected"
        )
        self.combox_ab_item.setv("padding-left: 4px", k="hover:!selected")
        self.combox_ab_item.setv(
            f"border-left: 2px solid {DTheme.g_color}", k="hover:!selected"
        )
        self.combox_ab_item.setv(
            f"background: {DTheme.g_select_bg_color}", k="selected"
        )
        self.combox_ab_item.setv(f"padding-left: 4px", k="selected")

        self.checkbox = Gss("QCheckBox")
        self.checkbox.setv(f"color: {DTheme.g_color}")

        self.file_dialog = Gss("QFileDialog")
        self.file_dialog.setv(f"background-color:{DTheme.g_bg_color}")

        self.header_view = Gss("QHeaderView")
        self.header_view.setv(f"color:{DTheme.g_color}")
        self.header_view.setv(f"background-color:{DTheme.g_bg_color}")
        self.header_view.setv(f"selection-color:{DTheme.g_color}")
        self.header_view.setv(f"selection-background-color:{DTheme.g_bg_color}")

        self.header_view_section = Gss("QHeaderView::section")
        self.header_view_section.setv(f"border: none")
        self.header_view_section.setv(f"color:{DTheme.g_color}")
        self.header_view_section.setv(f"background-color:{DTheme.g_bg_color}")

        self.lab1 = Gss("GNumberLabel")
        self.lab1.setv(f"color:{DTheme.g_color}")
        self.lab1.setv(f"background:{DTheme.g_bg_color}")

        self.list_widget = Gss("QListWidget")
        self.list_widget.setv(f"color:{DTheme.g_color}")
        self.list_widget.setv(f"background:{DTheme.g_bg_color}")
        ...
        self.list_widget_item.setv(
            f"border-left: 3px solid {DTheme.g_color}", k="focus"
        )
        self.list_widget_item.setv(f"background: {DTheme.g_hover_bg_color}", k="hover")
        self.list_widget_item.setv(
            f"background: {DTheme.g_select_bg_color}", k="selected"
        )
        self.list_widget_item.setv(
            f"border-left: 3px solid {DTheme.g_left_select_color}", k="selected"
        )

        self.list_view = Gss("QListView")
        self.list_view.setv(f"color: {DTheme.g_color}")
        self.list_view.setv(f"background: {DTheme.g_bg_color}")

        self.list_view_item = Gss("QListView::item")
        self.list_view_item.setv(f"color: {DTheme.g_color}")
        self.list_view_item.setv(f"background: {DTheme.g_bg_color}")

        self.line_edit = Gss("QLineEdit")
        self.line_edit.setv(f"color: {DTheme.g_color}")
        self.line_edit.setv(f"background: {DTheme.g_bg_color}")
        self.line_edit.setv("outline: none")
        self.line_edit.setv(f"border: 1px solid {DTheme.g_bg_d_color}")
        self.line_edit.setv(f"border: 1px solid {DTheme.g_bg_d_color}")
        self.line_edit.setv(f'font-family: "SF Mono SC";')
        self.line_edit.setv(f"font-size: 12pt")

        # 选中文本的背景色
        self.line_edit.setv(f"selection-background-color: {DTheme.g_bg_s_color}")
        self.line_edit.setv(f"selection-color: {DTheme.g_color}")
        # 只读状态
        self.line_edit.setv(f"color: {DTheme.g_color}", k="read-only")
        self.line_edit.setv(f"background-color: {DTheme.g_bg_d_color}", k="read-only")
        # 禁用状态
        self.line_edit.setv(f"color: {DTheme.g_color}", k="disabled")
        self.line_edit.setv(f"background-color: {DTheme.g_bg_d_color}", k="disabled")
        ...
        self.scroll_bar.setv(f"background-color: {DTheme.g_bg_color}", k="vertical")
        ...
        self.scroll_bar.setv(f"background-color: {DTheme.g_bg_color}", k="horizontal")
        ...
        self.scroll_bar_handle.setv(
            f"background-color: {DTheme.g_bg_d_color}", k="vertical"
        )
        self.scroll_bar.setv("min-width: 8px", k="vertical")
        # horizontal
        self.scroll_bar_handle.setv("border: none", k="horizontal")
        self.scroll_bar_handle.setv(
            f"background-color: {DTheme.g_bg_d_color}", k="horizontal"
        )
        ...
        self.scroll_bar_subpage.setv(
            f"background-color: {DTheme.g_bg_color}", k="vertical"
        )
        self.scroll_bar_subpage.setv(
            f"background-color: {DTheme.g_bg_color}", k="horizontal"
        )
        # add-page
        ...
        self.slide_groove.setv(f"background-color: {DTheme.g_bg_color}", k="horizontal")
        ...
        self.slide_groove.setv(f"background: {DTheme.g_bg_color}", k="horizontal")
        ...
        self.tree_view.setv(f"color: {DTheme.g_color}")
        self.tree_view.setv(f"background: {DTheme.g_bg_color}")

        self.tooltip = Gss("QToolTip")
        self.tooltip.setv(f"color: {DTheme.g_color}")
        self.tooltip.setv(f"background: {DTheme.g_bg_color}")
        self.tooltip.setv(f"border: 1px solid {DTheme.g_border_color}")
        ...
        self.menu_bar.setv(f"background: {DTheme.g_bg_color}")
        self.menu_bar.setv(f"color: {DTheme.g_color}")
        self.menu_bar.setv("border: none")

        self.menu_bar_item = Gss("QMenuBar::item")
        self.menu_bar_item.setv(f"background: {DTheme.g_bg_color}")
        self.menu_bar_item.setv(f"color: {DTheme.g_color}")
        self.menu_bar_item.setv(f"background: {DTheme.g_bg_color}", k="selected")
        self.menu_bar_item.setv(f"color: {DTheme.g_color}", k="selected")
        self.menu_bar_item.setv(f"color: {DTheme.g_color}", k="!selected")

        self.menu = Gss("QMenu")
        self.menu.setv(f"background: {DTheme.g_bg_color}")
        self.menu.setv(f"border: 1px solid {DTheme.g_border_color}")
        self.menu.setv(f"color: {DTheme.g_color}")
        ...
        self.menu_item.setv(f"background-color: {DTheme.g_bg_color}", k="selected")
        self.menu_item.setv(f"color: {DTheme.g_color}", k="selected")
        self.menu_item.setv("margin-left: 0px", k="selected")
        self.menu_item.setv(
            f"selection-background-color: {DTheme.g_select_bg_color}", k="selected"
        )
        self.menu_item.setv(f"background: {DTheme.g_bg_color}", k="disabled")
        self.menu_item.setv(f"color: {DTheme.g_color}", k="disabled")
        ...
        self.menu_separator.setv(f"border-top: 2px solid {DTheme.g_border_color}")
