...
class GDefaultTheme(object):
    ...
    def __init__(self):
        ...
        self.button.setv(f"background-color: {self.g_bg_color}")
        self.button.setv("padding: 0")
        self.button.setv(f"background-color: {self.g_hover_bg_color}", k="hover")
        self.button.setv(f"background-color: {self.g_hover_bg_color}", k="pressed")
        ...
        self.btn2.setv(f"color: {self.g_min_color}", k="hover")
        self.btn2.setv(f"background-color: {self.g_min_color}", k="hover")
        self.btn2.setv(f"color: {self.g_min_color}", k="pressed")
        self.btn2.setv(f"background-color: {self.g_min_color}", k="pressed")

        self.btn3 = Gss("GTMaxButton")
        self.btn3.setv("background-color: transparent")
        self.btn3.setv(f"color: {self.g_max_color}", k="hover")
        self.btn3.setv(f"background-color: {self.g_max_color}", k="hover")
        self.btn3.setv(f"color: {self.g_max_color}", k="pressed")
        self.btn3.setv(f"background-color: {self.g_max_color}", k="pressed")

        self.btn4 = Gss("GTOffButton")
        self.btn4.setv("background-color: transparent")
        self.btn4.setv(f"color: {self.g_off_color}", k="hover")
        self.btn4.setv(f"background-color: {self.g_off_color}", k="hover")
        self.btn4.setv(f"color: {self.g_off_d_color}", k="pressed")
        self.btn4.setv(f"background-color: {self.g_off_d_color}", k="pressed")

        self.btn5 = Gss("GOKButton")
        self.btn5.setv("border: none")
        self.btn5.setv(f"background-color: {self.g_ok_color}")
        self.btn5.setv("border-radius: 4px")

        self.btn6 = Gss("GNOButton")
        self.btn6.setv("border: none")
        self.btn6.setv(f"background-color: {self.g_no_color}")
        ...
        self.btn8.setv(f"border: 1px solid {self.g_color}")
        self.btn8.setv(f"background-color: {self.g_bg_color}")
        self.btn8.setv(f"background-color: {self.g_bg_d_color}", k="hover")
        self.btn8.setv(f"border: 1px solid {self.g_border_color}", k="hover")
        self.btn8.setv(f"background-color: {self.g_max_color}", k="pressed")
        self.btn8.setv(f"border: 1px solid {self.g_border_color}", k="pressed")

        self.btn9 = Gss("GOffButton")
        self.btn9.setv(f"background-color: {self.g_off_color}")
        self.btn9.setv(f"color: {self.g_off_color}", k="hover")
        self.btn9.setv(f"background-color: {self.g_off_color}", k="hover")
        ...
        self.combox.setv(f"color: {self.g_color}")
        ...
        self.combox.setv(f"background: {self.g_bg_color}", k="focus")
        # combox 点击样式
        ...
        self.combox_ab_item.setv(f"color: {self.g_color}")
        self.combox_ab_item.setv(f"background: {self.g_bg_color}")
        self.combox_ab_item.setv("padding-left: 4px")
        self.combox_ab_item.setv("padding-right: 0px")
        self.combox_ab_item.setv(f"background: {self.g_bg_color}", k="hover:!selected")
        self.combox_ab_item.setv("padding-left: 4px", k="hover:!selected")
        self.combox_ab_item.setv(
            f"border-left: 2px solid {self.g_color}", k="hover:!selected"
        )
        ...
        self.header_view.setv(f"selection-color:{self.g_color}")
        self.header_view.setv(f"selection-background-color:{self.g_bg_color}")
        ...
        self.list_widget_item.setv(f"border-left: 3px solid {self.g_color}", k="focus")
        self.list_widget_item.setv(f"background: {self.g_hover_bg_color}", k="hover")
        self.list_widget_item.setv(
            f"background: {self.g_select_bg_color}", k="selected"
        )
        self.list_widget_item.setv(
            f"border-left: 3px solid {self.g_left_select_color}", k="selected"
        )

        self.list_view = Gss("QListView")
        self.list_view.setv(f"color: {self.g_color}")
        self.list_view.setv(f"background: {self.g_bg_color}")
        ...
        # 只读状态
        self.line_edit.setv(f"color: {self.g_color}", k="read-only")
        self.line_edit.setv(f"background-color: {self.g_bg_d_color}", k="read-only")
        # 禁用状态
        ...
        self.scroll_bar.setv(f"background-color: {self.g_bg_color}", k="vertical")
        ...
        self.scroll_bar.setv(f"background-color: {self.g_bg_color}", k="horizontal")
        ...
        self.scroll_bar_subpage.setv(
            f"background-color: {self.g_bg_color}", k="vertical"
        )
        self.scroll_bar_subpage.setv(
        ...
        self.slide_groove.setv(f"background: {self.g_bg_color}", k="horizontal")
        ...
        self.tooltip.setv(f"border: 1px solid {self.g_border_color}")
        ...
        self.menu_bar_item.setv(f"background: {self.g_bg_color}")
        self.menu_bar_item.setv(f"color: {self.g_color}")
        self.menu_bar_item.setv(f"background: {self.g_bg_color}", k="selected")
        self.menu_bar_item.setv(f"color: {self.g_color}", k="selected")
        self.menu_bar_item.setv(f"color: {self.g_color}", k="!selected")

        self.menu = Gss("QMenu")
        self.menu.setv(f"background: {self.g_bg_color}")
        self.menu.setv(f"border: 1px solid {self.g_border_color}")
        self.menu.setv(f"color: {self.g_color}")
        ...
        self.menu_item.setv(f"background-color: {self.g_bg_color}", k="selected")
        self.menu_item.setv(f"color: {self.g_color}", k="selected")
        self.menu_item.setv("margin-left: 0px", k="selected")
        self.menu_item.setv(
            f"selection-background-color: {self.g_select_bg_color}",
            k="selected",
        )
        self.menu_item.setv(f"background: {self.g_bg_color}", k="disabled")
        self.menu_item.setv(f"color: {self.g_color}", k="disabled")
        ...
        self.menu_separator.setv(f"border-top: 2px solid {self.g_border_color}")
